...
public final class CropMiniReport {
    ...
    public static String create(
        ...
        json.put("crop_supports_consensus", item.cropSupportsConsensus);
        json.put("consensus_observations", item.consensusObservations);
        json.put("mz_attempt_index", item.mzAttemptIndex);
        json.put("layout", item.layout);
        json.put("row_counts", new JSONArray(item.rowCounts));
        json.put("fresh_prediction", item.freshPrediction);
        ...
        json.put("plate_geometry", item.plateGeometry.toJson());
        json.put("image_difficulty", item.imageDifficulty.toJson());
